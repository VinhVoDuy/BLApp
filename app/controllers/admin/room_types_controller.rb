class Admin::RoomTypesController < AdminController
  ...
  def room_type_params
    params.require(:room_type).permit(:name, :title, :description, :short_description, :size, :fake_features, :price, :capacity, :init_price, :bed_type, room_images_attributes: [:id, :image, :_destroy, :primary])
  end
end
